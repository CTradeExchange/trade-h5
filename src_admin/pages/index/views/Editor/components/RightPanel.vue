            ...
            <el-scrollbar class='right-scrollbar'>
                <el-form v-if='activated' label-width='90px' size='small'>
                    ...
                    <el-form-item label='有效期'>
                        <el-date-picker v-model='activeData.expiryDate' end-placeholder='结束日期' format='YYYY-MM-DD HH:mm:ss' range-separator='至' start-placeholder='开始日期' type='datetimerange' :unlink-panels='true' />
                    </el-form-item>
