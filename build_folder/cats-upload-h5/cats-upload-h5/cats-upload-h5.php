<?php
/*
Plugin Name: Cats H5上传插件
Plugin URI: http://www.cats-trade.com
Description: Cats H5文件上传插件
Version: 1.0
Author: ken.wang
...
//定义插件启动时候调用的方法
register_activation_hook( __FILE__, 'cats_start_upload_h5_install');

function cats_start_upload_h5_install() {
 ...
 * @return string
 */
function uploadH5HttpPost(string $url, $data, int $timeout = 60): string
{
    $ch = curl_init();
