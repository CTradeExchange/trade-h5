...
class SocketEvent {
    constructor () {
        ...
        this.subscribedKlineList = [] // 上一次获取行情列表K线折线图数据
    ...
    */
    ...
    add_subscribe24H ({ moduleId, symbolKeys }) {
        ...
        this.send_subscribe24H([...new Set(symbolkeyAll)])
    ...
    // 盘口成交报价订阅
    deal_subscribe (symbol_id, depth_level = 10, merge_accuracy, trade_type, trade_info_count = 5) {
    ...
    onOpen () {
        ...
        if (this.subscribedKlineList.length) this.batchGetKlineData(this.subscribedKlineList)
