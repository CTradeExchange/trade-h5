...
/**
 * 查询货币对的交易汇率
 * @param sourceCurrency - 源货币编码
 * @param targetCurrency - 目标货币编码
 */
export function getTradeExchangeRate (data) {
    return request({
        url: '/global/fund.app.FundExchangeRateQueryService.getTradeExchangeRate',
        method: 'post',
        toastErr: false,
        headers: {
            version: '0.0.1'
