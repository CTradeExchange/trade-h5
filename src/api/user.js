...
import { delNewsToken, getDevice } from '@/utils/util'
...
/* 检查某个地址是否在支持提现范围内 */
export function checkSupportWalletAddress (data) {
    return request({
        // url: '/api/cats-gateway/global/config.app.AppDictDubboService.getListByParentCode',
...
/* 资金划转支持不同币种 */
export function capitalTransferSupportDiffCurr (data) {
    return request({
        url: '/global/fund.app.DepositAppDubboService.capitalTransferSupportDiffCurr',
        method: 'post',
        headers: {
            version: '0.0.1'
        },
...
export function socialRegister (data) {
    return request({
        url: '/third/login/customer.app.CustomerThirdLoginService.socialRegister',
        method: 'post',
        toastErr: false,
        headers: {
            version: '0.0.1'
...
export function socialLogin (data) {
    return request({
        url: '/third/login/customer.app.CustomerThirdLoginService.socialLogin',
        method: 'post',
        toastErr: false,
        headers: {
            version: '0.0.1'
...
/* 查询客户email phone */
export function findPhoneAndEmail (data) {
    return request({
        url: '/global/customer.app.CustomerWebApiService.findPhoneAndEmail',
        method: 'post',
        headers: {
            version: '0.0.1',
        },
...
export function updateCountry (data) {
    return request({
        url: '/global/customer.app.CustomerWebApiService.changeCountry',
        method: 'post',
        headers: {
            version: '0.0.1',
        },
...
export function bindThirdAccount (data) {
    return request({
        url: '/global/customer.app.CustomerWebApiService.bindThirdAccount',
        method: 'post',
        headers: {
            version: '0.0.1'
        },
...
/* 获取客户已绑定三方账户信息 */
export function findThirdAccountInfo (data) {
    return request({
        url: '/global/customer.app.CustomerWebApiService.findThirdAccountInfo',
        method: 'post',
        headers: {
            version: '0.0.1'
        },
