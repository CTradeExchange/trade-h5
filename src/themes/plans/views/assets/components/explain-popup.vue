<template>
    <van-popup v-model:show='show' class='explain-popup' position='bottom' round teleport='body' @close='close'>
        <div class='popup-content p-5'>
            ...
            <template v-if='explainType === 4'>
                ...
                <div v-if='customerInfo' class='warning-ul'>
                ...
                <div v-if='customerInfo' class='explain-case'>
                    <div class='title'>
            ...
            <van-button class='mt-4 w-full rounded-xs' type='primary' @click='close'>
                {{ $t('common.know') }}
            </van-button>
        </div>
    </van-popup>
