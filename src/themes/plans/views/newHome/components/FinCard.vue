    ...
    <div class='finCard'>
        <!-- <div class="filterBox">
            <div class="filterTop">
                ...
                <div class='filterDate' @click="$emit('changeDate')">
                    <img
                        class='calendarIcon'
                        src='../../../../../assets/newUI/calendar.png'
                    />
                    <input
                        v-model='startTime'
                        disabled
                        :placeholder="$t('news.yearMonthDay')"
                    />
                </div>
        ...
        <FilterBlock @change='changeConditions' />
        <van-pull-refresh
            v-model='refresh'
        ...
        >
            <div v-if='isEmpty(data) && !loading && !error'>
                <van-empty
            ...
            >
                <div
                    ...
                    :key='index'
                    class='card-item'
                    @click="$router.push({ name:'EconomicCalendar',query:{ id:item.ID,itemID:getItemID(item) } })"
                >
                    <div v-if='isShowDate(item, index)' class='publishTime'>
                        <span>{{ publishDate(item.PublishTime) }}</span>
                    </div>
                    <div class='itemTop'>
                        ...
                        <div class='itemBody'>
                            ...
                            <div class='itemMain'>
                                ...
                                <div
                                    v-if='!isHoliDay(item.Description)'
                                    class='bodyRight'
                                >
                                    ...
                                    >
                                        <img
                                            src='../../../../../assets/newUI/search-yellow.png'
                                        />
                                    </div>
                                    <div
                                    ...
                                    >
                                        <img
                                            src='../../../../../assets/newUI/search-orange1.png'
                                        />
                                        <img
                                            src='../../../../../assets/newUI/search-orange1.png'
                                        />
                                    ...
                                    >
                                        <img
                                            src='../../../../../assets/newUI/search-red1.png'
                                        />
                                        <img
                                            src='../../../../../assets/newUI/search-red1.png'
                                        />
...
export default {
    ...
    components: { template, FilterBlock },
    props: {
        startTime: {
            type: String,
            default: ''
    ...
    setup (props, { emit }) {
        ...
        const getItemID = (item) => {
            ...
            const { ItemLanguages } = item || {}
            if (!isEmpty(ItemLanguages)) {
                const currentItem = ItemLanguages.find(
