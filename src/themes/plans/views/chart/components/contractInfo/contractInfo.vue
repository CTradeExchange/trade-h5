<template>
    <div class='contractWrapper'>
        <!-- <LayoutTop bottom-line :title='product.symbolName' /> -->
        <div class='container'>
            ...
            <van-cell v-if='!product.isMakingMatch' :title="$t('contract.limitDistance')" :value='product.priceMinLimit+"/"+product.priceMaxLimit+ $t("contract.point")' />
...
import { sortTimeList, timeListFormat, timeListSort } from './contractInfo'
...
export default {
    ...
    setup (props) {
        ...
        QuoteSocket.send_subscribe([props.symbolId])
