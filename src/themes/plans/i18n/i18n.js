...
export function setupI18n(locale) {
    const i18n = createI18n({ locale, globalInjection: true ,warnHtmlMessage: false})
...
export async function loadLocaleMessages(i18n, locale) {
    ...
    const signalMessages = await import(/* webpackChunkName: "locale-[request]" */ `@/plugins/signal/i18n/${locale}.json`)
    const newMessages = Object.assign({},commonMessages.default, messages.default, signalMessages.default)
