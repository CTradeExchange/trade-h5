<template>
    <div class='stepper focus-within'>
        <button ref='minus' class='minus van-stepper__minus cursor-pointer' :disabled='disabledM' @click='minus'>
        ...
        <input
            ...
            @input='input'
        />
        <button ref='plus' class='plus van-stepper__plus cursor-pointer' :disabled='disabledP' @click='plus'>
...
export default {
    ...
    data () {
        return {
            disabledM: this.disabledMinus,
            disabledP: this.disabledPlus,
        }
    },
    computed: {
        placeholderText () {
    ...
    watch: {
        modelValue: {
            handler (val) {
                if (parseFloat(val) <= parseFloat(this.min) || !val) {
                    this.disabledM = true
                } else {
    ...
    methods: {
        minus () {
            if (this.disabledM) return false
