<template>
    <div class='page-wrap'>
        <LayoutTop absolute back left-icon='arrow-left' :right-action='false' show-center>
            <template #left>
                <span class='icon_icon_close_big' @click='$router.back()'></span>
            </template>
        </LayoutTop>
...
<script>
import { onBeforeMount, computed, reactive, watch, toRefs, ref } from 'vue'
