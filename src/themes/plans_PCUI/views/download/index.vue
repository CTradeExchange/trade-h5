...
// 下载地址
const downloads = {
    'ios': 'https://starapp016.com:1888/i7qq.app',
    'android': 'https://play.google.com/store/apps/details?id=uni.UNI8B7D0E0'
}
// 打开下载地址
const openDownload = value => {
    window.open(downloads[value])
}
</script>
    ...
    .content {
        ...
        .qr-code {
            .code-img {
                ...
                border: 8px solid rgb(94, 102, 115);
                border-radius: 8px;
                img {
                    width: 100%;
                }
