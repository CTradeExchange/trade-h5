            ...
            <div class='footer-auto'>
                <el-row class='row1' :gutter='10'>
                    <el-col
                        ...
                        :xs='22'
                    >
                        <img alt='' class='logo' src='../../../images/investingCom/headlineLogo.png' @click='jumpUrl("home")' />
                    ...
                    >
                        ...
                        <div class='downloadRow'>
                            <img alt='' class='download' src='../../../images/investingCom/googlePlay.png' @click='jumpUrl("gg")' />
                            <img alt='' class='download download2' src='../../../images/investingCom/appleStore.png' @click='jumpUrl("apple")' />
                            <img alt='' class='download download2' src='../../../images/investingCom/telegram.png' @click='jumpUrl("tg")' />
                        </div>
                    </el-col>
                    <el-col
                        class='col3'
                    ...
                    >
                        ...
                        <div class='socialMediaRow'>
                            <img alt='' class='socialMedia socialMedia1' src='../../../images/investingCom/facebook.png' @click='jumpUrl("fb")' />
                            <img alt='' class='socialMedia socialMedia2 socialMedia6' src='../../../images/investingCom/twitter.png' @click='jumpUrl("twitter")' />
                            <img alt='' class='socialMedia socialMedia3 socialMedia6' src='../../../images/investingCom/youtube.png' @click='jumpUrl("yt")' />
                            <img alt='' class='socialMedia socialMedia4 socialMedia6' src='../../../images/investingCom/instagram.png' @click='jumpUrl("ig")' />
                            <img alt='' class='socialMedia socialMedia5 socialMedia6' src='../../../images/investingCom/linkedin.png' @click='jumpUrl("linkedin")' />
                        </div>
                    </el-col>
                </el-row>
                <div class='newDiv'>
                    ...
                    <div class='downloadRow'>
                        <img alt='' class='download' src='../../../images/investingCom/telegram.png' @click='jumpUrl("tg")' />
                    </div>
                </div>
            </div>
        </div>
  ...
  .row1{
      ...
      .col3{
        ...
        .socialMediaRow{
          ...
          .socialMedia1:hover{
              content: url("../../../images/investingCom/facebook-hover.png");
              cursor: pointer;
          }
          .socialMedia2:hover{
              content: url("../../../images/investingCom/twitter-hover.png");
              cursor: pointer;
          }
          .socialMedia3:hover{
              content: url("../../../images/investingCom/youtube-hover.png");
              cursor: pointer;
          }
          .socialMedia4:hover{
              content: url("../../../images/investingCom/instagram-hover.png");
              cursor: pointer;
          }
          .socialMedia5:hover{
              content: url("../../../images/investingCom/linkedin-hover.png");
              cursor: pointer;
          }
          .socialMedia6{
            margin-left: 24px;
