<template>
    ...
    <SelectProduct v-model='dialogProductVisible' @closed='onClosed' @onSelect='onSelect' />
</template>
...
const locale = computed(() => element_local[i18n.global.locale] || en)
...
const filterList = {
    ...
    direction: [
        ...
        { text: t('trade.long'), value: 1 },
        { text: t('trade.short'), value: 2 },
    ],
    positionType: [
