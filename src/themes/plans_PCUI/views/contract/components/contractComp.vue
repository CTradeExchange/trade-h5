<template>
    <div class='contractWrapper'>
        ...
        <LayoutTop icon='icon_icon_close_big' :title='product.symbolName' />
        <div class='container'>
            ...
            <van-cell v-if='!product.isMakingMatch' :title="$t('contract.singleTradeMargin')" :value='product.singleMinAmount+"-"+product.singleMaxAmount' />
