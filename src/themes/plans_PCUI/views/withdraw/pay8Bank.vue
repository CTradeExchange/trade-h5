        ...
        <div class='pageWrap'>
            ...
            <div class='wrap'>
                ...
                <div class='receipt-info'>
                    ...
                    <el-select v-model='channelCode' clearable :placeholder="$t('pay8Account.bankSelect')" @change='changeBank'>
                        <el-option
    ...
    setup (props) {
        ...
        const queryBankList = () => {
            queryPayWithdrawBankList({
                ...
                if (receiptInfo?.code) {
                    state.channel = state.channelList.find(el => el.code === receiptInfo.code) || {}
                    state.channelCode = state.channel.code
                }
            })
        }
        ...
        const changeBank = (value) => {
            state.channel = state.channelList.find(el => el.code === value) || {}
        }
