            ...
            <div class='main' :class="inAnimation?'anim':''" @animationend='inAnimation=false'>
                ...
                <form class='loginForm'>
                    ...
                    <div v-if="loginType==='password'" class='field'>
                        ...
                        >
                            <div class='eyeBtn' @click.stop="inputType= inputType==='password'?'text':'password'">
                                <img :class="[inputType==='password'?'eyeOpenIcon':'eyeClosedIcon']" :src="inputType==='password'?eyeOpenIcon:eyeClosedIcon" />
                            </div>
                        </compInput>
                    </div>
                    <div v-else class='field'>
                    ...
                    <div class='loginBtnDiv'>
                        <van-button block class='loginBtn' :disabled='loading' @click='loginHandle'>
                            {{ $t('signIn.loginBtn') }}
                        </van-button>
                    </div>
                </form>
...
.login {
    ...
    .main {
        ...
        @keyframes showMsg
        {
            ...
            50% {transform: rotateY(65deg);opacity: 0;}
