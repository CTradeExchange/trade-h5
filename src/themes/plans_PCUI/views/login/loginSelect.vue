        ...
        <div class='container'>
            ...
            <div class='rightBox'>
                <div class='Rcontainer'>
                    ...
                    <div class='epbtn' @click='toLogin'>
                        <img alt='' src='/images/userBtnIcon.svg' /> {{ $t('login.pwdOrEmail') }}
                    </div>
                    <!-- <div class='tipsBox'>
                        {{ $t('login.goRegister') }}&nbsp;
                        <div class='hot' @click='goRegister'>
                            {{ $t('login.register') }}
                        </div>
                    </div> -->
                </div>
...
const toLogin = () => {
    router.push(`/login/select?loginType=${state.loginType}`)
}
const goRegister = () => {
