<template>
    ...
    <div v-if='!loading' id='infoDetailID' class='info-detail'>
    ...
    setup () {
        ...
        const getInfo = (ID) => {
            ...
            GetItemByID({ body: { ID: Number(ID), Language: getCookie('lang') || 'en-US' } }).then((res) => {
                ...
                const formatInfo = { Trades, ViewpointID, Viewpoints, UserPortrait, Content, Keywords, PublishTime, Source, SourceURL, Title, TotalLikeCount, ID, ContentType, EmbedLink, EmbedExtra, EmbedSource, EmbedButton }
                state.info = Object.assign(formatInfo, {})
