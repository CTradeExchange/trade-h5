    ...
    const getDefaultProduct = (tradeType) => {
        ...
        if (lastProductSymbolKey) {
            ...
            if (arr.length) {
                ...
                // console.log('btcItem=====>', Object.values(arr))
