...
const routes = [
    {
        ...
        name: 'Login',
        component: () =>
            import(/* webpackChunkName: "login" */ '../user/login/loginSelect.vue'),
        meta: {
            title: 'cRoute.login',
    ...
    },
    {
        ...
        name: 'RegisterStep1',
        component: () =>
            import(/* webpackChunkName: "login" */ '../user/register/register-step1.vue'),
        meta: {
            title: 'cRoute.register',
            // roles: ['Guest'],
        },
    },
    {
        ...
        name: 'RegisterStep2',
        component: () =>
            import(/* webpackChunkName: "login" */ '../user/register/register-step2.vue'),
        meta: {
            title: 'cRoute.register',
            // roles: ['Guest'],
        },
    },
    {
        ...
        name: 'RegisterStep3',
        component: () =>
            import(/* webpackChunkName: "login" */ '../user/register/register-step3.vue'),
        meta: {
            title: 'cRoute.register',
            // roles: ['Guest'],
        },
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "register" */ '../user/register/registerSuccess.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(/* webpackChunkName: "login" */ '../user/register/registerNg.vue'),
        meta: {
            title: 'cRoute.register',
            roles: ['Guest'],
        },
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "login" */ '../user/register/appRegister.vue'
            ),
        meta: {
            title: 'mfa.bind',
            // roles: ['Guest'],
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "Register" */ '../user/register/registerHandler.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "resetPwd" */ '../user/forgot/resetLoginPwd.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "resetPwd" */ '../user/forgot/resetFundPwd.vue'
            ),
        meta: {
            title: 'cRoute.resetPwd',
        },
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "resetSuccess" */ '../user/forgot/resetSuccess.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "resetFail" */ '../user/forgot/resetFail.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "page" */ '../user/withdraw/withdrawAccount.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "withdraw" */ '../user/withdraw/withdrawMoney.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "withdraw" */ '../user/withdraw/withdrawCoin.vue'
            ),
        meta: {
            title: 'cRoute.withdraw',
            footerMenu: false,
    ...
    {
        path: '/withdrawfundPwd',
        name: 'WithdrawfundPwd',
        component: () =>
            import(
                /* webpackChunkName: "withdraw" */ '../user/withdraw/withdrawfundPwd.vue'
            ),
        meta: {
            title: 'cRoute.withdraw',
            footerMenu: false,
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "withdraw" */ '../user/withdraw/withdrawRedeem.vue'
            ),
        meta: {
            title: 'cRoute.withdraw',
            footerMenu: false,
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "withdraw" */ '../user/withdraw/pay8Account.vue'
            ),
        meta: {
            title: 'cRoute.withdraw',
            footerMenu: false,
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "withdraw" */ '../user/withdraw/pay8Bank.vue'
            ),
        meta: {
            title: 'cRoute.withdraw',
            footerMenu: false,
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "withdrawRecord" */ '../user/withdraw/withdrawRecord.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "walletAddress" */ '../user/walletAddress.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "addBank" */ '../user/deposit/depositRecord.vue'
            ),
        meta: {
    ...
    //     component: () =>
    //         import(/* webpackChunkName: "personal" */ '../user/personalInformation.vue'),
    //     meta: {
    //         title: 'cRoute.personalInformation',
    //         footerMenu: false,
    //         // roles: ['User'],
    //     },
    // },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "authentication" */ '../user/authentication.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "google_MFA" */ '../user/google_MFA/status.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "google_MFA" */ '../user/google_MFA/install.vue'
            ),
        meta: {
            title: 'cRoute.MFA_status',
            roles: ['User'],
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "google_MFA" */ '../user/google_MFA/secretKey.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "google_MFA" */ '../user/google_MFA/bind.vue'
            ),
        meta: {
            title: 'cRoute.MFA_bind',
            roles: ['User'],
    ...
    // api管理模块
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "api_Manage" */ '../user/api_Manage/list.vue'
            ),
        meta: {
            title: 'api.title',
        },
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "api_Manage" */ '../user/api_Manage/create.vue'
            ),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "api_Manage" */ '../user/api_Manage/edit.vue'
            ),
        meta: {
    ...
    // jwt
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "api_Manage" */ '../user/pageJwt.vue'
            ),
        meta: {
            title: 'cRoute.helpCenter',
            //   roles: ["User"],
        },
    },
    // service
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "api_Manage" */ '../user/pageAda.vue'
            ),
        meta: {
            title: 'cRoute.customerService',
            //   roles: ["User"],
        },
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "api_Manage" */ '../user/eventLink.vue'
            ),
        meta: {
            title: 'cRoute.customerService',
            //   roles: ["User"],
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "api_Manage" */ '../user/legal/privacyPolicy.vue'
            ),
        meta: {
            title: 'cRoute.customerService',
            //   roles: ["User"],
    ...
    //     path: "/appCaptcha",
    //     name: "appCaptcha",
    //     component: () => import("../user/appCaptcha"),
    //     meta: {
    //       title: "cRoute.appCaptcha",
    //     },
    //   },
]
