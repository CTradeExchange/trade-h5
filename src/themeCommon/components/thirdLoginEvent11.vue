...
import LoginByGoogle from '@/themeCommon/user/login/components/loginByGoogleEvent6.vue'
...
import LoginByTelegram from '@/themeCommon/user/login/components/loginByTelegramEvent6.vue'
