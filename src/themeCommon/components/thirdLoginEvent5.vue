<template>
    <div v-if='thirdLoginArr.length > 0' class='three-way-login'>
        <div class='otherLogin'>
            ...
            <el-button class='tradeNow lp_btn lp_btn_register' plain text @click='jumpPage(1)'>
...
import LoginByGoogle from '@/themeCommon/user/login/components/loginByGoogleEvent3.vue'
...
import LoginByTelegram from '@/themeCommon/user/login/components/loginByTelegramEvent3.vue'
...
.tradeNow{
    background-color: #05852D !important;
    color: #fff;
