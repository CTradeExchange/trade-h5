<template>
    <img alt='' class='icon icon_yuyan' src='../../../../themes/plans_PCUI/images/investingCom/language.png' style='width: 20px' />
    <el-dropdown>
        <i style='outline: unset !important' :title="$t('common.lang')">
