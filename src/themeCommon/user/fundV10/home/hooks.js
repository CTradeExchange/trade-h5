import { marketPerformance, marketPerformanceQuoteChange, investCombination, assetPerformance } from '@/api/trade'
...
export const useChart = (params = {}) => {
    ...
    // 绘制柱状图
    const newBarChart = (chartDom, [xData, yData], rotate = 0) => {
        const myChart = echarts.init(chartDom)
        const option = {
            backgroundColor: style.contentColor,
            tooltip: {
