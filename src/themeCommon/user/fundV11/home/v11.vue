    ...
    <div class='wrap'>
        ...
        <div :class="['module-content', isPC ? 'pc-content' : 'h5-content']">
            ...
            <div v-if='isPC' class='pc-bg'>
                <img class='blue1-bg animation-spin' :src="require('@public/images/V11/pc/blue1_bg.png')" />
                <img class='blue2-bg animation-spin' :src="require('@public/images/V11/pc/blue2_bg.png')" />
            </div>
            <!-- H5背景 -->
            <div v-else class='h5-bg'>
                <img class='blue1-bg animation-spin' :src="require('@public/images/V11/h5/blue1_bg.png')" />
                <img class='blue2-bg animation-spin' :src="require('@public/images/V11/h5/blue2_bg.png')" />
            </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <span class='name'>
                                ...
                                <img class='badge' :src="require('@public/images/V11/badge.png')" />
                            </span>
                        </li>
                        <li>
                            <span class='name'>
                ...
                <div class='module-case max-limit'>
                    ...
                    <div class='trend-chart'>
                        ...
                        <div class='block trend-block'>
                            <div class='above'>
                                <img class='pic' :src="isPC ? require('@public/images/V11/pc/trend_chart.jpg') : require('@public/images/V10/h5/trend_chart.jpg')" />
                            </div>
                            <div class='below'>
                                <p class='text'>
