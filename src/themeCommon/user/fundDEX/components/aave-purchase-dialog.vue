<template>
            ...
            <div class='popup-model'>
                ...
                <div v-if='showSuccess' class='success-content'>
                    <div class='success-block'>
                        ...
                        <div v-if='getDevice() === 4' class='add-box'>
                ...
                <div v-else class='model-content'>
                    <div class='block'>
                        <div class='title'>
                            <label>Amount</label>
                            <van-popover v-model:show='showAmountPopover' :offset='[50, 8]' placement='top'>
    ...
    <!-- 授权提示弹窗 -->
    <aave-approve-tip v-model:show='showApproveTip' text='Before purchasing, you need to approve its usage by the Aave protocol.' />
</template>

<script setup>
import { ref, computed, watch, defineExpose, defineEmits, unref } from 'vue'
import { useStore } from 'vuex'
import { isEmpty, debounce, getDevice } from '@/utils/util'
...
const onInput = (e) => {
    ...
    if (gt(newval, assetBalance.value)) newval = assetBalance.value
...
// 点击MAX
const onMax = () => {
    if (assetBalance.value <= 0 || purchaseLoading.value) return
