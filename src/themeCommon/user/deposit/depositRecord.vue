<template>
    ...
    <div class='filter-wrap'>
        <van-dropdown-menu :active-color='style.primary' :overlay='true'>
            <van-dropdown-item ref='timeDropdown' v-model='timeVal' :options='timeList' @change='timeChange'>
                ...
                >
                    ...
                    >
                        <van-collapse-item :name='index + 1'>
                            ...
                            <template #right-icon>
                                <div>
                                    <span class='state' :class='stateClasas(item.checkStatus, item.depositStatus)'>
                            ...
                            <div class='withdraw-desc'>
                                ...
                                <div class='w-item'>
                                    ...
                                    <span class='right-val state' :class='stateClasas(item.checkStatus, item.depositStatus)'>
                                        {{ handleState(item.checkStatus, item.depositStatus) }}
                                    </span>
                                </div>
