<template>
    <div class='pageWrap'>
        ...
        <LayoutTop bottom-line :right-action='rightAction' @rightClick='rightClick' />
        <div class='wrap'>
            <p class='header-text'>
            ...
            <div class='bank-wrap'>
                ...
                <div v-if='!isEmpty(checkedBank)' class='bank bank-flex' @click='openSheet'>
                    ...
                    <van-icon class='bank-card' name='card' />
                    <span class='bank-no'>
                        {{ checkedBank?.bankName }} {{ hideMiddle(checkedBank?.bankAccount) }}
                    </span>
        ...
        <div class='bank-list'>
            ...
            >
                <div class='bank-item'>
                    ...
                    <van-icon class='bank-card' name='card' />
                    <div class='bank-no'>
                        <p>{{ item.bankName }} {{ hideMiddle(item.bankAccount) }}</p>
...
.bank {
    ...
    .bank-card {
        ...
        font-size: rem(48px);
        height: rem(40px);
        margin: rem(20px) rem(15px) rem(38px) rem(30px);
    }
    .van-icon {
        height: rem(40px);
