<template>
    ...
    <LayoutTop v-if='props.isShow' :back='true' bottom-line :menu='false' />
                        ...
                        <van-collapse-item :name='index+1'>
                            <template #title>
                                ...
                                <div class='amount'>
                                    ...
                                    <div v-if='item.withdrawType === 2'>
                                        <div class='amount'>
                                            {{ item.accountCurrency }}
                                        </div>
                                        <div style='font-weight:400'>
                                            {{ item.blockchainName }}&nbsp;|&nbsp;{{ hideWalletMiddleInfo(item.bankCardNo,'...') }}
                                        </div>
                                    </div>
                                </div>
                            </template>
                            <template #right-icon>
                                <div class='right-lump'>
                                    <van-icon class='h-6' :name='activeIndex === index+1 ? "arrow-up" : "arrow-down"' />
                                    <div>{{ item.amount }}&nbsp;{{ item.withdrawCurrency }}</div>
                                    <span class='state' :class='stateClasas(item.checkStatus,item.transferStatus)'>
                            ...
                            <div class='withdraw-desc'>
                                ...
                                <div class='w-item'>
                                    ...
                                    <span class='right-val state' :class='stateClasas(item.checkStatus,item.transferStatus)'>
                                        {{ handleState(item.checkStatus,item.transferStatus) }}
                                    </span>
                                </div>
...
import { isEmpty, hideWalletMiddleInfo } from '@/utils/util'
